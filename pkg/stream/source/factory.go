...
func FromIterator(name string, iterator iterator.Iterator, attributes ...stream.StageAttribute) *stream.SourceGraph {
...
func Single(value interface{}, attributes ...stream.StageAttribute) *stream.SourceGraph {
...
func Combine(name string, graphs []*stream.SourceGraph, strategy stream.FanInStrategy, attributes ...stream.StageAttribute) *stream.SourceGraph {
